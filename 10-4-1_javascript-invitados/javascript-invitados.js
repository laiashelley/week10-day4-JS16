...
function button1(){
    ...
    for (let i = 0; i < invitadosFiestaInicial.length; i++){
        lista1.innerHTML += invitadosFiestaInicial[i] + "<br>";
...
function button2(){
    ...
    for (let i = 0; i < invitadosFiestaInicial.length; i++){
        lista2.innerHTML += invitadosFiestaInicial[i] + "<br>";
        console.log(invitadosFiestaInicial[i]);
    }

    lista2.style.fontFamily ="Arial";
}
...
function button3(){
    ...
    for (let i = 0; i < invitadosFiestaFinal.length; i++){
        lista3.innerHTML += invitadosFiestaFinal[i] + "<br>";
        console.log(invitadosFiestaFinal[i]);
    }

    lista3.style.fontFamily ="Arial";
}
...
function button4(){
    ...
    for (let i = 0; i < invitadosFiestaFinal.length; i++){
        lista4.innerHTML += invitadosFiestaFinal[i] + "<br>";
        console.log(invitadosFiestaFinal[i]);
    }

    lista4.style.fontFamily ="Arial";
}
...
function buscador(){
    ...
    if (invitadosFiestaFinal.includes(nombreBuscador)){
